...
//LISTAR
app.get('/autos_bd', verificar_jwt, (request:any, response:any)=>{
...
//AGREGAR
app.post('/autos_bd', alta_baja, upload.single("foto"), (request:any, response:any)=>{
...
//MODIFICAR
app.post('/autos_bd/modificar', modificar, upload.single("foto"), (request:any, response:any)=>{
...
//ELIMINAR
app.post('/autos_bd/eliminar', alta_baja, (request:any, response:any)=>{
